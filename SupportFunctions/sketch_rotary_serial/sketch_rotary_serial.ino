...
Add digitalwritefast.h to your arduino library folder and replace the line with "Wprogram.h"
with "Arduino.h" with a text editor, you can remove call to wiring.h
*/
...
void setup() {
  Serial.begin(115200); // I haven't had luck with 115200. Might be my USB hub. 9600 works fine.
