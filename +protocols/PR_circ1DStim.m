classdef PR_circ1DStim < handle
  ...
  methods (Access = public)
    function o = PR_circ1DStim(winPtr)
      o.winPtr = winPtr;
    ...
    function initFunc(o,S,P);
       ...
       o.ProbeHistory = zeros(o.MaxFrame,5);  % x,y,ori,fixated,texture
       ...
       o.Bars0 = stimuli.circ1Dnoise(o.winPtr,'bkgd',S.bgColour,'gray',false); % 1D noise as probe
       %o.Bars.prctgray = 33.33;
       o.Bars0.sparsity = 0;
       o.Bars0.texnum = 1;
       o.Bars0.Ntex = (120*20*10); %1 trials at 120fps
       o.Bars0.barwidth  = round(P.barwidth*S.pixPerDeg);
       o.Bars0.radius    = round(P.proberadius*S.pixPerDeg);
       o.Bars0.prefori   = P.prefori;
       o.Bars0.pixPerDeg = S.pixPerDeg;
       
       o.Bars0.makeTex();
       
       o.Bars1 = stimuli.circ1Dnoise(o.winPtr,'bkgd',S.bgColour,'gray',false); % 1D noise as probe
       %o.Bars.prctgray = 33.33;
       o.Bars1.sparsity = 1;
       o.Bars1.texnum = 1;
       o.Bars1.Ntex = (120*20*10); %1 trials at 120fps
       o.Bars1.barwidth  = round(P.barwidth*S.pixPerDeg);
       o.Bars1.radius    = round(P.proberadius*S.pixPerDeg);
      ...
      o.Bars2 = stimuli.circ1Dnoise(o.winPtr,'bkgd',S.bgColour,'gray',false); % 1D noise as probe
       %o.Bars.prctgray = 33.33;
       o.Bars2.sparsity = 2;
       o.Bars2.texnum = 1;
       o.Bars2.Ntex = (120*20*10); %1 trials at 120fps
       o.Bars2.barwidth  = round(P.barwidth*S.pixPerDeg);
       o.Bars2.radius    = round(P.proberadius*S.pixPerDeg);
